...
1. Load the following datasets:
    ...
    ```{r message=FALSE}
    phones <- read_csv("https://raw.githubusercontent.com/altaf-ali/tidydata_tutorial/master/data/phones.csv")
    postcodes <- read_csv("https://raw.githubusercontent.com/altaf-ali/tidydata_tutorial/master/data/postcodes.csv")
    ```
