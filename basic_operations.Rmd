...
```{r message = FALSE}
flights <- read_csv("https://altaf-ali.github.io/tidydata_tutorial/data/flights.csv")
weather <- read_csv("https://altaf-ali.github.io/tidydata_tutorial/data/weather.csv")
planes <- read_csv("https://altaf-ali.github.io/tidydata_tutorial/data/planes.csv")
airports <- read_csv("https://altaf-ali.github.io/tidydata_tutorial/data/airports.csv")
```
...
```{r}
flights %>%
  unite(flight_id, carrier, flight, sep = "-")
```
